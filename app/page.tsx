  ...
  const featuredProjects = [
    {
      ...
      description: "A complete online shopping solution with payment integration and inventory management.",
    ...
    },
    {
      ...
      description: "An intuitive analytics dashboard for a subscription-based software service.",
      image: "/placeholder.svg?height=400&width=600",
    ...
    },
    {
      ...
      description: "A secure and user-friendly mobile banking application with real-time transaction tracking.",
      image: "/placeholder.svg?height=400&width=600",
  ...
  const featuredTemplates = [
    {
      ...
      description: "A fully responsive admin dashboard template with dark mode support.",
      image: "/placeholder.svg?height=300&width=400",
      category: "Dashboard",
      downloads: 1250,
      link: "/templates/admin-dashboard",
    },
    {
      id: 2,
      ...
      category: "E-commerce",
      downloads: 980,
      link: "/templates/ecommerce-starter",
    },
    {
      id: 3,
